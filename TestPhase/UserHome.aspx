<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserHome.aspx.cs" Inherits="TestPhase.UserHome" %>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li role="separator" class="divider"></li>
                                    <li ><a href="TileCategory.aspx">Tile Category</a></li>
                                    <li ><a href="TileCompany.aspx">Tile Company</a></li>
                                </ul>
                            </li>
