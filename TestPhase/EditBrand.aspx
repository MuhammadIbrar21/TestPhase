<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="EditBrand.aspx.cs" Inherits="TestPhase.EditBrand" %>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="alert-info text-center">All Companies</h4>
                        <br />
